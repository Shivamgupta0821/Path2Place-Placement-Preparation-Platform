...
<button onClick={() => googleLogin()}
  className="mb-5 flex w-full items-center justify-center gap-3 rounded-xl border border-[#2a2a2a] bg-[#1a1a1a] py-3 text-[14px] text-white transition-colors hover:border-[#3a3a3a] hover:bg-[#202020]"
>
